...
- ニュースは3つに限定すること。
- タイトルは必ず日本語で、誰でも分かるように噛み砕いて説明すること。
- 技術用語は避けて、日常的に使う言葉で言い換えること。
- 各ニュースの「注目ポイント」を1行でわかりやすく説明すること。
- 難しい言葉は絶対に使わず、小学生でも理解できる言葉で言う。

【例】
❌ 悪い例：「ChatGPT-4のTransformerアーキテクチャがアップデート」
✅ 良い例：「ChatGPTがもっと賢くなった！会話がより自然に」

❌ 悪い例：「機械学習アルゴリズムの最適化」
✅ 良い例：「AIがもっと早く答えを出せるようになった！」`
          },
          {
            role: 'user',
